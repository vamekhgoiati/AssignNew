...
public class FieldVerifier {
	...
	public static boolean isValidEmail(String email){
		return email.matches("[A-Za-z0-9._%+-][A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{3}") || email.equals("");
	}
	
	public static boolean isValidPhone(String phone){
		return phone.matches("[0-9]+") || phone.equals("");
	}
	
	public static boolean isValidFax(String fax){
		return fax.matches("[0-9]+") || fax.equals("");
	}
	...
	public static boolean isValidDate(String date){
		...
		try {
			Date regDate = myDateTimeFormat.parseStrict(date);
			return true;
